...
#TODO CUSTOM_STAKING_ADDRESS must be updated with the correct contract address when it is deployed
export CUSTOM_STAKING_ADDRESS="0xf8a415d761b1279B0f1ACE68cD85e5ca4346Cc3F"
...
# TODO Remove this line once contract is correctly updated above
