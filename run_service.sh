...
ensure_minimum_balance() {
    ...
    echo "    - Balance: $(wei_to_dai $balance)"
    ...
    if [ "$waited" = true ]; then
        printf "\r      Waiting...   \n"
        echo "    - Updated balance: $(wei_to_dai $balance)"
    fi
...
then
    ...
    ensure_minimum_balance $operator_address $suggested_amount "Please, ensure the Operator's balance is at least $(wei_to_dai $suggested_amount)."
    ensure_minimum_balance $agent_address $suggested_amount "Please, ensure your Agent instance's balance is at least $(wei_to_dai $suggested_amount)."    
...
ensure_minimum_balance $SAFE_CONTRACT_ADDRESS $suggested_amount "Please, ensure your service Safe's balance is at least $(wei_to_dai $suggested_amount)."
