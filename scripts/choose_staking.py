...
NO_STAKING_PROGRAM_ENV_VARIABLES = {
    ...
    "CUSTOM_STAKING_ADDRESS": "0x389B46c259631Acd6a69Bde8B6cEe218230bAE8C",  # Non-staking agents need to specify an arbitrary staking contract so that they can call getStakingState()
