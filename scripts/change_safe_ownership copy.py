...
if __name__ == '__main__':
    ...
    try:
        ...
        message = {
            "to": safe.address,
            "value": 0,
            "data": HexBytes(w3.to_bytes(hexstr=data)),
            "operation": 0,
            "safeTxGas": 0,
            "baseGas": 0,
            "dataGas": 0,
        ...
        payload = {
            "types": types,
            "primaryType": "SafeTx",
            "domain": {"verifyingContract": args.safe_address},
            "message": message,
        }
        ...
        signed_message1 = w3.eth.account.sign_message(encode_defunct(txn_hash), private_key=args.current_owner_private_key)
